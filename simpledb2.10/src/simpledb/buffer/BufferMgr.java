...
public class BufferMgr {
   ...
   /**
	 * CS4432-Project1:
	 * BasicBufferMgr is changed to AdvancedBufferMgr here.
	 */
   ...
   /**
	 * CS4432-Project1:
	 * Prints out the buffer pool status when pin is called.
	 */
   public synchronized Buffer pin(Block blk) {
      try {
         ...
         System.out.println(this.bufferMgr);
         return buff;
      }
   ...
   /**
	 * CS4432-Project1:
	 * Prints out the buffer pool status when pinNew is called.
	 */
   ...
   /**
	 * CS4432-Project1:
	 * Prints out the buffer pool status when unpin is called.
	 */
