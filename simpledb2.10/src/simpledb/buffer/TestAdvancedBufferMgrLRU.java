/**
 * CS4432-Project1:
 * These are the test cases for LRU replacement policy. 
 * To run this test case, change "policyConfig" variable in "AdvancedBufferMgr" class to "LRU".
 */
...
public class TestAdvancedBufferMgrLRU {
	public static void main(String[] args)
	{
		...
		try{
			...
			*/
			 ...
			 * CS4432-Project1:
			 * The first test case:
			 * Test for normal LRU case, the least recent used one will be replaced. The first test case covers the following condition:
			 * - The least recent accessed buffer that is not pinned will be replaced.
			 * - The access time will be properly updated upon access.
			 */
			//account
			...
			//Use select to pin blocks. The time for these blocks are updated.		
			...
			//Insert a new record, this will replace the least recently used unpinned block.
...
//				System.out.println(srs.getString("CName"));
//			}
//			//Do several selects to pin the buffers.
//			s = "select State from ADDRESS";
//			srs = (SimpleResultSet) stmt.executeQuery(s);
//			while(srs.next())
//			{
