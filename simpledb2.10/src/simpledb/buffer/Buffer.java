...
public class Buffer {
   ...
   /**
	 * CS4432-Project1:
	 * Define variables that record pin status and dirty.
	 */
   //This indicates whether this buffer is pinned or not.
   private int pins = 0;
   //This indicates whether it is modified, if it's modified, record the transaction number for the modification.
   private int modifiedBy = -1;
   private int logSequenceNumber = -1; // negative means no corresponding log record
   /**
	 * CS4432-Project1:
	 * Defines variables that record frame number, time for LRU replacement policy and reference bit for CLOCK policy.
	 */
   ...
   /**
	 * CS4432-Project1:
	 * getters and setters for time, reference bit and frame number.
	 */
   public long getTime()
   {
	   return this.time;
   }
   public void setTime(long currTime)
   {
	   this.time = currTime;
   }
   public void setRef()
   ...
   public String toString()
   {
	   ...
	   if(this.blk == null)
	   {
		   result = "Buffer id: " + this.frameNum + " block: null" + " pin status: " + this.pins;
	   }
	   else
	   {
		   result = "Buffer id: " + this.frameNum + " block: " + this.block().toString() + " pin status: " + this.pins; 
	   }
	   return result;
   }
